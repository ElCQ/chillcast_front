...
import { ScrollView, Text, View, Image, TouchableOpacity, ActivityIndicator, Dimensions } from 'react-native'
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#232323' }}>
      <View className="px-6" style={{ backgroundColor: '#232323', paddingTop: 50 }}>
        ...
        {/* Ordenar y Filtrar */}
        <View className="flex-row items-center justify-between mb-6 mt-4 py-2" style={{ minHeight: 40 }}>
          <View className="flex-row items-center">
            <FontAwesome name="sliders" size={18} color="#fff" style={{ marginRight: 8 }} />
            <Text className="text-white font-medium" style={{ fontFamily: 'System' }}>Ordenar y Filtrar</Text>
          </View>
          {tab === 'Listas' && (
            <TouchableOpacity
      ...
      >
                ...
                >
                  ...
                  >
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 4 }}>
                      <Text style={{ color: '#D0D0D0', fontSize: 14, flex: 1, fontFamily: 'System' }} numberOfLines={1}>
                        {podcast.description || 'Podcast'}
                      </Text>
                      <FontAwesome name="star" size={14} color="#FFD600" style={{ marginLeft: 8, marginRight: 2 }} />
                      <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 13, fontFamily: 'System' }}>
                        {('5')}/5
                      </Text>
                    </View>
                    <View style={{ flexDirection: 'row', marginTop: 4 }}>
                      {(defaultGenres).map((g, i) => (
                        <Text
                          key={i}
                          style={{
        ...
        {tab === 'Reseñas' && (
          <Text className="text-white text-center mt-10" style={{ fontFamily: 'System' }}>Aca van tus reseñas</Text>
        )}
        {tab === 'Historial' && (
          <View style={{ gap: 16 }}>
              ...
              >
                ...
                >
                  ...
                  <Text
                    ...
                    numberOfLines={1}
                  >
                    Visitado por última vez: <Text style={{ color: '#fff', fontWeight: 'bold' }}>{'Sin datos'}</Text>
                  </Text>
                </View>
              </TouchableOpacity>
            ))}
