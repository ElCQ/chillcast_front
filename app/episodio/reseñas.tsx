  ...
  const reseñas = [
      {
        ...
        nombre: 'Juan Pérez',
        valoracion: 4.7,
        texto: 'El episodio sobre salud mental fue muy útil. Me gustó cómo explicaron la importancia de pedir ayuda.',
      },
      {
        id: 2,
        nombre: 'Ana Gómez',
        valoracion: 5,
        texto: 'Me encantó el episodio sobre productividad. Las estrategias que compartieron ya las estoy aplicando.',
      },
      {
        id: 3,
        nombre: 'Carlos López',
        valoracion: 3.5,
        texto: 'El episodio sobre hábitos estuvo bien, pero sentí que faltaron ejemplos más prácticos.',
      }
    ];
